...
void Matrix3D::Transform(float dst[4], Matrix3D& mat, const float vec[4])
{
	double tmp[4], invW;
	int i;
...
void Matrix3D::MultMatrix(Matrix3D& dst, Matrix3D& src1, Matrix3D& src2)
{
	float tmp[16];
	int i, j;
...
void Matrix3D::MakeTranslateMatrix(float x, float y, float z, Matrix3D& m)
{
...
void Matrix3D::MakeRotateMatrix(float angle, float ax, float ay, float az, Matrix3D& m)
{
...
void Matrix3D::MakeScaleMatrix(float scaleX, float scaleY, float scaleZ, Matrix3D& m)
{
	m[0]  = scaleX;
	m[1]  = 0;
	m[2]  = 0;
...
void Matrix3D::InvertMatrix(Matrix3D* out, Matrix3D* m)
{
...
void Matrix3D::BuildLookAtMatrix(double eyex, double eyey, double eyez,  
